...
## Tech Stack
ktreharrison/write-docker-actions is built on the following main stack:
...
|:------|:------|:------|:------|:------|:------|
|[requests](https://pypi.org/project/requests)|N/A|01/17/22|Ken Harrison |Apache-2.0|N/A|
